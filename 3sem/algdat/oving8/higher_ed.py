...
class HigherEdSolver:
    ...
    def initialize(self, institutions):
        for institution in institutions:
            self.institutions[institution] = None

    def parent_institution(self, institution):
        if self.institutions[institution] == None:
            return institution
        else:
            return self.parent_institution(self.institutions[institution])

    def fuse(self, institution1, institution2, new_institution):
        self.institutions[new_institution] = None
        self.institutions[institution1] = new_institution
        self.institutions[institution2] = new_institution
